...
- **Breaking Change**: Migrated agent command configuration from Markdown frontmatter to a centralized `.config/agent_commands.yaml` file.
  - This improves maintainability and allows for cleaner command templates.
