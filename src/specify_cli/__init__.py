...
def _github_token(cli_token: str | None = None) -> str | None:
    ...
    return ((cli_token or os.getenv("SPEC_GITHUB_PAT_ENV_NAME") or os.getenv("GH_TOKEN") or os.getenv("GITHUB_TOKEN") or "").strip()) or None
...
def select_with_arrows(options: dict[str, str], prompt_text: str = "Select an option", default_key: str | None = None) -> str:
    """
